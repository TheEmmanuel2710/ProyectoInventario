...
class EntradaMaterial(models.Model):
    entNumeroFactura = models.CharField(max_length=15,db_comment="Numero de la factura")
    ...
    entEntregadoPor = models.CharField(max_length=101,db_comment="Nombre persona que entrega los materiales")
...
class DetalleEntradaMaterial(models.Model):
    ...
    matUnidadMedida = models.ForeignKey(UnidadMedida,on_delete=models.PROTECT,default=None,
...
class SolicitudElemento(models.Model):
    ...
    solFechaHoraFin = models.DateTimeField(null=True,db_comment="Fecha y hora que devuelven los elementos")
