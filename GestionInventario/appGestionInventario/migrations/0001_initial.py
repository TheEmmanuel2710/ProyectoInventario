...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('entNumeroFactura', models.CharField(db_comment='Numero de la factura', max_length=15)),
                ('entFechaHora', models.DateTimeField(db_comment='Fecha y hora que entregan los elementos', default=datetime.datetime(2023, 5, 18, 22, 50, 27, 684038, tzinfo=datetime.timezone.utc))),
                ('entEntregadoPor', models.CharField(db_comment='Nombre persona que entrega los materiales', max_length=101)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detEstado', models.CharField(choices=[('Bueno', 'Bueno'), ('Bueno', 'Regular'), ('Bueno', 'Malo')], db_comment='estado del Elemento', max_length=7)),
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ...
                ('matUnidadMedida', models.ForeignKey(db_comment='Hace referencia a la Unidad de Medida FK', default=None, on_delete=django.db.models.deletion.PROTECT, to='appGestionInventario.unidadmedida')),
            ],
        ),
    ]
